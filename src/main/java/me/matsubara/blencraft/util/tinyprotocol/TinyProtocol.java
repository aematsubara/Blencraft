package me.matsubara.blencraft.util.tinyprotocol;
...
import me.matsubara.blencraft.util.tinyprotocol.Reflection.FieldAccessor;
import me.matsubara.blencraft.util.tinyprotocol.Reflection.MethodInvoker;
        ...
        endInitProtocol = new ChannelInitializer<Channel>() {
            ...
            protected void initChannel(Channel channel) {
                try {
                    ...
                    plugin.getLogger().log(Level.SEVERE, "Cannot inject incomming channel " + channel, exception);
                }
            }
    ...
    private final class PacketInterceptor extends ChannelDuplexHandler {
        ...
        public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
            try {
                ...
                plugin.getLogger().log(Level.SEVERE, "Error in onPacketOutAsync().", exception);
            }
